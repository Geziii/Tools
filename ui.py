...
class MyLabel(QLabel):
    ...
    def mousePressEvent(self, e):
        ...
        self.pixel_x = e.x()
        self.pixel_y = e.y()
        print(str(self.pixel_x/0.75)+','+str(self.pixel_y/0.75))
...
class ImageDialog(QDialog):
    ...
    def initFile(self):
        self.index = 5
        self.step = 25
        self.validation_step = 71
        self.point_num = 8
        self.pic_dir = '../data/rar/Section' + str(self.index) + 'CameraC/'
        self.img_dir = '../data/image/'
        self.anno_dir = '../data/annotation/'
        self.validation_img_dir = '../data/validation/image/'
        self.validation_anno_dir = '../data/validation/annotation/'
        #选择训练集图片
        #select_pic(self.pic_dir, self.img_dir, self.step, self.index)
        #选择验证集图片
